...
public class NodeController : MonoBehaviour {
    ...
    const string WRITE_DATABASE = "api-data.cnfllrhicyva.us-east-2.rds.amazonaws.com";
    const string READ_DATABASE = "api-data.cnfllrhicyva.us-east-2.rds.amazonaws.com";
    const string MAP_NAME = "devMap1";
